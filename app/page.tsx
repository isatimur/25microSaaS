...
const statusConfig = {
  ...
  upcoming: { icon: Clock, color: "text-neutral-500", bg: "bg-neutral-800" },
};
    ...
    <div className="min-h-screen">
        ...
        <section className="h-[40rem] w-full bg-brand-blue relative flex flex-col items-center justify-center antialiased">
          <div className="max-w-4xl mx-auto p-4 relative z-10">
            ...
            <p className="text-xl text-white/80 max-w-2xl mx-auto text-center mb-8">
              Transform your ideas into reality, even if you&apos;re not a
              full-time coder!
            </p>
        ...
        <div className="container mx-auto px-10 space-y-32">
          ...
          <section className="space-y-12 animate-slide-up">
            ...
            <p className="text-xl text-center text-brand-gray max-w-3xl mx-auto">
              Build 25 micro Software-as-a-Service (SaaS) projects over the
              course of 50 weeks. Perfect for aspiring entrepreneurs, hobbyist
              coders, and anyone looking to boost their tech skills!
            </p>
          ...
          <section className="bg-white shadow-xl rounded-2xl p-12 space-y-8 animate-fade-in">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <BenefitItem
                ...
                text="Develop a diverse portfolio of projects"
              />
              <BenefitItem
                icon={<Code className="w-6 h-6 text-blue-500" />}
                text="Learn new technologies and best practices"
              />
              <BenefitItem
                icon={<Trophy className="w-6 h-6 text-blue-500" />}
                text="Potentially generate passive income streams"
              />
              <BenefitItem
                icon={<Rocket className="w-6 h-6 text-blue-500" />}
                text="Boost your problem-solving skills"
              />
              <BenefitItem
                icon={<Users className="w-6 h-6 text-blue-500" />}
                text="Network with other aspiring SaaS creators"
              />
              <BenefitItem
                icon={<Calendar className="w-6 h-6 text-blue-500" />}
                text="Get expert guidance and resources"
              />
            </div>
          </section>
            ...
            <div className="container mx-auto">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-xl text-center text-neutral-400 mb-8">
                  Get updates on new projects, behind-the-scenes insights, and
          ...
          <section className="text-center bg-gradient-to-r from-blue-700 to-blue-900 text-white py-16 rounded-2xl space-y-8 animate-fade-in">
            ...
            <p className="text-xl max-w-2xl mx-auto mb-8">
              Join now and turn your coding hobby into a portfolio of real,
              working products!
            </p>
            <Button
              size="lg"
      ...
      <footer className="bg-gray-100 py-12 mt-32">
        <div className="container mx-auto px-4 text-center text-gray-600">
          <p className="mb-4">
            &copy; 2025 MicroSaaS Challenge. All rights reserved.
          </p>
...
function BenefitItem({
  ...
  return (
    <div className="flex items-center space-x-4 group">
      ...
      <span className="text-lg text-gray-700 group-hover:text-blue-600 transition-colors duration-300">
        {text}
      </span>
    </div>
  );
...
function StepItem({ number, text }: { number: number; text: string }) {
  return (
    <div className="flex flex-col items-center text-center group">
      ...
      <p className="text-lg text-gray-700 group-hover:text-blue-600 transition-colors duration-300">
        {text}
      </p>
    </div>
  );
...
function NextProjectCountdown() {
  ...
  if (!nextProjectStart) {
    return (
      <p className="text-2xl text-gray-600">All projects have started!</p>
    );
  }
